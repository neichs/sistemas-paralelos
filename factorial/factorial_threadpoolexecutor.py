...
def main() -> None:
    parser = argparse.ArgumentParser(description="Factoriales en paralelo con ThreadPoolExecutor")
    ...
    print_result("concurrent.futures.ThreadPoolExecutor", numbers, args.workers, mean_value, elapsed)
